...
export default new Vuex.Store({
    state: {
        ...
        authorize: {
            ...
            redirectUrl: 'https://sporator.netlify.com/check', // Testing: http://localhost:8080/check or to: https://sporator.netlify.com/check if deployed
            showDialog: true
        },
        access: {
            accessToken: '',
    ...
    actions: {
        ...
        createSimilarTrackPlaylist(context, {
            id,
            name
        }) {
            const metaData = {
            ...
            const tracks = context.dispatch('fetchSimilarTrack', {
                id
            })
            tracks.then(result => {
        ...
        async createArtistTopTracksPlayList(context, {
            id,
            name
        }) {
            const metaData = {
